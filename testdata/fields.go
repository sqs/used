...
type t17 struct{ f171, f172 int } // MATCH /t17 is used 0 times/
// MATCH:28 /f183 is used 0 times/
type t18 struct{ f181, f182, f183 int } // MATCH /f182 is used 0 times/
...
type t21 struct{ f211, f212 int } // MATCH /f211 is used 0 times/
...
func foo() {
	...
	_ = a2{0: {1}}
	_ = map[[1]t16]int{{{1}}: 1}
	y := struct{ x int }{} // MATCH /x is used 0 times/
	_ = y
	_ = t18{f181: 1}
	_ = []m2{{"a": {1}}}
	_ = [][]m3{{{"a": {1}}}}
